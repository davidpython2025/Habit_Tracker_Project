...
class HabitController:
    ...
    def view_longest_streak_all(self):
        ...
        # Find all habits with the maximum streak, this handles the case where multiple habits have the same streak
        best_habits = []
        ...
        if len(best_habits) == 1:
            ...
            # I used a list comprehension to format each habit
